...
public abstract class WhetzelControllerType2 : MonoBehaviour
{
    ...
    {
        ScanForFabot();
        transform.LookAt(GetComponent<Rigidbody2D>().velocity + GetComponent<Rigidbody2D>().position, new Vector3(0, 0, 1));
    }
